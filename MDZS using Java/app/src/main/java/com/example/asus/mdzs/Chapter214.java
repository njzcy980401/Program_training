...
public class Chapter214 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chapter214);
        list = new ArrayList<>();
        list.add("魏&无&羡\n" +
                "好&啦&好&啦&，&我&在&外&面&喝");
        ...
        findViewById(R.id.button2).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Chapter214.this,MyList.class);
    ...
    private void showNextText() {
        if (index<list.size()){
            ...
            findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(Chapter214.this, Chapter215.class);
                    startActivity(intent);
    ...
    public void onBackPressed(){
        if(lastBack == 0|| System.currentTimeMillis() - lastBack > 2000){
            Toast.makeText(Chapter214.this,"再按一次退出当前进度",Toast.LENGTH_LONG).show();
