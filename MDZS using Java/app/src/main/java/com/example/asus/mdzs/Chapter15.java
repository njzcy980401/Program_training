...
public class Chapter15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add("莫&夫&人\n" +
                "（&吸&气&）\n"+
        "阿&渊& &阿&渊&啊&啊&啊");
        list.add("我&的&儿&啊&啊&啊&啊\n" +
        "你&死&的&好&惨&啊&啊&啊&");
        list.add("你&就&这&么&走&了&啊\n"+
        "你&让&娘&可&怎&么&办&啊&啊& & 我&的&儿&啊");
        list.add("死&疯&子& &我&要&你&偿&命& &偿&命&！&！");
        ...
        findViewById(R.id.button2).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Chapter15.this,MyList.class);
    ...
    private void showNextText() {
        if (index<list.size()){
            ...
            findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(Chapter15.this,Chapter16.class);
                    startActivity(intent);
    ...
    public void onBackPressed(){
        if(lastBack == 0|| System.currentTimeMillis() - lastBack > 2000){
            Toast.makeText(Chapter15.this,"再按一次退出当前进度",Toast.LENGTH_LONG).show();
