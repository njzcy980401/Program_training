...
public class Chapter14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add("莫&夫&人\n" +
                "都&给&我&滚&开&！&！");
        list.add("阿& &这& &这&是&.&.");
        list.add("不& &不&可&能& &不&可&能& &这&不&是&我&的&阿&渊&！");
        ...
        findViewById(R.id.button2).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Chapter14.this,MyList.class);
    ...
    private void showNextText() {
        if (index<list.size()){
            ...
            findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(Chapter14.this,Chapter15.class);
                    startActivity(intent);
    ...
    public void onBackPressed(){
        if(lastBack == 0|| System.currentTimeMillis() - lastBack > 2000){
            Toast.makeText(Chapter14.this,"再按一次退出当前进度",Toast.LENGTH_LONG).show();
