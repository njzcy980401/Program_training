...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "H16000511", nullptr, nullptr);//后面两个属性--是否全屏、是否共享
    ...
    while (!glfwWindowShouldClose(window)) {  //判断窗口是否关闭，若窗口一直开着，则一直刷新屏幕
        ...
        lightPos=glm::vec3(20.0f,0.0f,1.0f);
        ...
        transform = glm::scale(transform, glm::vec3(0.5f, 0.5f, 0.5f));//对矩阵进行伸缩变换
