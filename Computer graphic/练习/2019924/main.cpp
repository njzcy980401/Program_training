...
Camera camera(glm::vec3(0.0f, 0.0f, 4.0f));//放2.0使得人往后挪
...
int main() {
    ...
    while (!glfwWindowShouldClose(window)){
      ...
      lightPos=glm::vec3(lightPos.x+translation3,lightPos.y+translation4,3.0f); glUniformMatrix4fv(glGetUniformLocation(lightShader.Program,"model"),1,GL_FALSE,glm::value_ptr(transform));
