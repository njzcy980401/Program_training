...
public class Chapter213 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chapter213);
        list = new ArrayList<>();
        list.add("蓝&忘&机\n" +
                "云&深&不&知&处&禁&酒");
        ...
        findViewById(R.id.button2).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Chapter213.this,MyList.class);
    ...
    private void showNextText() {
        if (index<list.size()){
            ...
            findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(Chapter213.this, Chapter214.class);
                    startActivity(intent);
    ...
    public void onBackPressed(){
        if(lastBack == 0|| System.currentTimeMillis() - lastBack > 2000){
            Toast.makeText(Chapter213.this,"再按一次退出当前进度",Toast.LENGTH_LONG).show();
