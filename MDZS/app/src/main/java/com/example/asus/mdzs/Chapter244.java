...
public class Chapter244 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chapter244);
        list = new ArrayList<>();
        list.add("江&枫&眠\n" +
                "阿&羡");
        list.add("起&来&吧\n" +
        ...
        findViewById(R.id.button2).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Chapter244.this,MyList.class);
    ...
    private void showNextText() {
        if (index<list.size()){
            ...
            findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(Chapter244.this,Chapter245.class);
                    startActivity(intent);
    ...
    public void onBackPressed(){
        if(lastBack == 0|| System.currentTimeMillis() - lastBack > 2000){
            Toast.makeText(Chapter244.this,"再按一次退出当前进度",Toast.LENGTH_LONG).show();
