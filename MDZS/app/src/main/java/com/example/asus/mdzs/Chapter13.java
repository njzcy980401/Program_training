...
public class Chapter13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button2).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Chapter13.this,MyList.class);
    ...
    private void showNextText() {
        if (index<list.size()){
            ...
            findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(Chapter13.this,Chapter14.class);
                    startActivity(intent);
    ...
    public void onBackPressed(){
        if(lastBack == 0|| System.currentTimeMillis() - lastBack > 2000){
            Toast.makeText(Chapter13.this,"再按一次退出当前进度",Toast.LENGTH_LONG).show();
